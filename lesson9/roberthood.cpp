...
long double rotating_calipers(vector<point> &cp) {
...
int main() {
  ...
  while (cin >> C) {
    ...
    auto convex_shots = convex_hull(shots);
    auto max_dist = rotating_calipers(convex_shots);
    cout << setprecision(15) << max_dist << endl;
  }
