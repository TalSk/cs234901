...
//          cout << "modify " << j << ", " <<  count << endl;
        ...
        for (ll j = start; j <= i; ++j) {
//          cout << "modify " << j << ", " <<  count << endl;
          segmentTreeB2::modify(j, count + 1);
...
//      cout << "case 3: "<< query(x + count_first, y - count_last + 1) << endl;
      cout << max(max(count_first, count_last), segmentTreeB2::query(x + count_first, y - count_last + 1)) << endl;
